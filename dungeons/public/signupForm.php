...
<main role="main">
    ...
    <form method="post" action=".">
        ...
        <label>First name</label><input class="infoform" type="text" name="first_name" size="40" required value="<?php
        if (ISSET($first_name)) {
            echo $first_name;
        }
        ?>"><br>
        <label>Last name</label><input class="infoform" type="text" name="last_name" size="40" required value="<?php
        if (ISSET($last_name)) {
            echo $last_name;
        }
        ?>"><br>
        ...
        <label>Confirm Password</label><input class="infoform" type="password" name="confirm_password" size="40" required><br>
